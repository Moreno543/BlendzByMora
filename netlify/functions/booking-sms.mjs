...
function buildBody(row) {
  ...
  let text = `Blendz By Mora: Hi ${first}! We received your request — ${service} on ${date} at ${time}. We'll confirm by email or phone soon. Thank you!`;
  if (text.length > 320) {
    text = `Blendz By Mora: Hi ${first}! Request received: ${service} on ${date} at ${time}. We'll confirm soon.`;
  }
  if (text.length > 320) {
